...
class ResourceModelDefaultValuesTests(TestCase):
    ...
    def test_resource_default_imageURL(self):
        self.assertEqual(self.test_resource.imageURL, default_data["imageUrl"])

    def test_resource_default_value_one(self):
        self.assertEqual(self.test_resource.value_one, default_data["loremIpsumShort"])
...
class ResourceModelTests(TestCase):
    ...
    def test_resource_title_max_length(self):
        title_max_length = self.test_resource._meta.get_field("title").max_length
        self.assertEqual(title_max_length, 250)

    def test_resource_author(self):
        self.assertEqual(self.test_resource.author, "Antoine de Saint-Exupéry")

    def test_resource_author_max_length(self):
        author_max_length = self.test_resource._meta.get_field("author").max_length
    ...
    def test_description_blank_true(self):
        description_blank = self.test_resource._meta.get_field("description").blank
    ...
    def test_value_three_blank_true(self):
        value_three_blank = self.test_resource._meta.get_field("value_three").blank
